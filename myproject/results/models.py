...
class Example(models.Model):
    ...
    code_wrong = models.CharField(max_length=800, help_text='Incorrect code example.')
    code_right = models.CharField(max_length=800, help_text='Correct code example.')
    desc_wrong = models.CharField(max_length=800, help_text='Why does the incorrect code not work?')
    desc_right = models.CharField(max_length=800, help_text='Why does the correct code work?')
    tags = TaggableManager()
...
class Tip(models.Model):
    ...
    desc = models.CharField(max_length=800, help_text='Tip main text')
    link = models.CharField(max_length=400, help_text='Link to resource')
    tags = TaggableManager()
